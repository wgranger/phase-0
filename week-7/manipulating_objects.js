...
I had trouble creating new objects at first, but I noticed it's as easy
as creating a path leading back to the original object and equaling it
to a new object. I was able to pass the tests once I first created an 
empty object and then placing a string in that object.

How difficult was it to add and delete properties outside of the object 
itself?

It was pretty easy. Deleting an object was as easy as typing delete and 
then naming the object afterwards. Adding to an object was as simply as
setting the variable equal to whatever was going to be written into it.

What did you learn about manipulating objects in this challenge?

It's fairly simply to add to an object using dot notation. I played around
with the objects a bit to see what would and wouldn't work when creating
new values and properties. I learned a couple ways of creating objects, 
by setting them to empty curly brackets or setting them equal to a new object.
*/
